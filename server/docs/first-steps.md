...
{_ ../../docs_src/first_steps/tutorial001_py310.py _}
...
{_ ../../docs_src/first_steps/tutorial001_py310.py hl[1] _}
...
{_ ../../docs_src/first_steps/tutorial001_py310.py hl[3] _}

Here the `app` variable will be an "instance" of the class `FastAPI`.

This will be the main point of interaction to create all your API.

### Step 3: create a _path operation_ { #step-3-create-a-path-operation }
...
#### Define a _path operation decorator_ { #define-a-path-operation-decorator }

{_ ../../docs_src/first_steps/tutorial001_py310.py hl[6] _}
...
{_ ../../docs_src/first_steps/tutorial001_py310.py hl[7] _}
...
{_ ../../docs_src/first_steps/tutorial003_py310.py hl[7] _}

/// note

If you don't know the difference, check the [Async: _"In a hurry?"_](../async.md#in-a-hurry).

///

### Step 5: return the content { #step-5-return-the-content }

{_ ../../docs_src/first_steps/tutorial001_py310.py hl[8] _}
