...
{_ ../../docs_src/dependencies/tutorial001_an_py310.py hl[8:9] _}
...
{_ ../../docs_src/dependencies/tutorial001_an_py310.py hl[3] _}
...
{_ ../../docs_src/dependencies/tutorial001_an_py310.py hl[13,18] _}
...
{_ ../../docs_src/dependencies/tutorial001_02_an_py310.py hl[12,16,21] _}
...
If you don't know, check the [Async: _"In a hurry?"_](../../async.md#in-a-hurry) section about `async` and `await` in the docs.
